...
\begin{table}[htbp]% Fix the table captions to sit directly on the table, but figures do NOT sit directly on the figure.
    \caption[Sample tabularx table]{A sample Table using tabularx. All tables should be left aligned OR the full width of the margin, like this one. }\label{sample}
